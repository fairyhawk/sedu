...
//		}
 	...
 	function toforpwd(){
 	 	window.open("http://highso.net.cn/static/web/column/132/index_1.shtml");
 	}
 ...
 function showLoginedMessage(username) {
   ...
   //注册后分配机会 谢添加
	...
	function showRegisterPage() {
 	   ...
 	   window.location.href="http://highso.net.cn/register";
 	   if(typeof(_gaq)!="undefinde"&&_gaq!=null){
 	...
 	function showLoginPage() {
 		...
 		window.location.href="http://highso.net.cn/login";
 		if(typeof(_gaq)!="undefinde"&&_gaq!=null){
