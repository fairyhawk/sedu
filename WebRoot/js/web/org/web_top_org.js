...
//			pageTracker = _gat._getTracker('UA-22575911-1');
//		}
		...
		$("#regForm").validate({
	        ...
	        success: function(label) {
	        	...
	        	if(loginMessageFlag == "new") {
	        		label.html("<img src='" + importURL + "/images/web/org/index/duihao_new.jpg'/>");
	        		return;
 	...
 	function toforpwd(){
 	 	window.open("http://highso.org/static/web/column/38/index_1.shtml");
 	}
	...
	function doafterreg(){
 	...
 	function showLoginInfo() {
 		if(isLogin()) {
			...
			if(loginMessageFlag == "new") {
				//$("#login_message_b").html("[<a class='btn_reg' href='javascript:showRegisterDiv()'>免费注册</a>] [<a class='btn_login' href='javascript:showLoginDiv()'>登录</a>]");
				return;
			}else if(loginMessageFlag == "new2"){
				//$("#login_message_b").html("<p>[<a class='btn_reg' href='javascript:showRegisterDiv()'>免费注册</a>]  [<a class='btn_login' href='javascript:showLoginDiv()'>登录</a>]</p>");
 ...
 function showLoginedMessage(username) {
	...
	function checkLoginTo(url) {
		if(typeof(_gaq)!="undefinde"&&_gaq!=null){
		_gaq.push(['_trackEvent', ' Entry', 'Study',' Index_Header']);//谷歌统计 添加事件追踪统计
		}
		forwordURL = url;
		if(hasLogin()) {
   ...
   //注册后分配机会 谢添加
	...
	function showRegisterPage() {
 	   ...
 	   window.location.href="http://highso.org/register";
 		
 	}
 	
 	function showLoginPage() {
 	
 		window.location.href="http://highso.org/login";
 		if(typeof(_gaq)!="undefinde"&&_gaq!=null){
