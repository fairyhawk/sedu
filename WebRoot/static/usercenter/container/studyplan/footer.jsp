...
<!-- 删除学习计划弹窗 -->
<div style="display:none" id="popupContactDeleteInfo">
	<div class="popupbc" id="popbc1"></div>
		<div class="popup" id="popbc2">
			<div class="title pl20 f14 lh200 bld">提示
				<a href="JavaScript:closeWin('popupContactDeleteInfo');"><div class="close_div"></div></a>
			</div>
			<div class="con">
		...
		<div class="pop_but">
			<a href="JavaScript:closeWin('popupContactDeleteInfo');window.location.href='<%=contextPath%>/stu/studyplanWeb!deletePlanitemById.action?planitem.pitemId=<s:property value='planitem.pitemId'/>';"><div class="popbut_qd fl ml100"></div></a>
			<a href="JavaScript:closeWin('popupContactDeleteInfo');"><div class="popbut_qx fr mr100"></div></a>
		</div>
	</div>
</div>

<!-- 取消编辑学习计划弹窗 -->
<div style="display:none" id="canclePopupContact">
	<div class="popupbc" id="popbc1"></div>
		<div class="popup" id="popbc2">
			<div class="title pl20 f14 lh200 bld">提示
				<a href="JavaScript:closeWin('canclePopupContact');"><div class="close_div"></div></a>
			</div>
			<div class="con">
				<div class="ml fl ml20 mt30"><img src="<%=importURL%>/images/usercenter/att_pic.jpg"  /></div>
				<div class="mr fr" id="canclePopupContactText">
				</div>
			</div>
		<div class="pop_but">
			<a href="JavaScript:closeWin('popupContactDeleteInfo');window.location='<%=contextPath%>/stu/calendar!getListPlanByCalendardGoto.action?checkDay=<s:property value='checkDay'/>';"><div class="popbut_qd fl ml100"></div></a>
			<a href="JavaScript:closeWin('canclePopupContact');"><div class="popbut_qx fr mr100"></div></a>
		</div>
	</div>
</div>
...
<div style="display:none" id="error_win">
	...
	<div class="title pl20 f14 lh200 bld">错误提示
		<a href="javascript:closeWin('error_win');"><div class="close_div"></div></a></div>
	<div class="con">
	<div class="ml fl ml20 mt30"><img src="<%=importURL%>/images/usercenter/att_pic3.jpg"  /></div>
	<div class="mr fr"><b id="error_message"></b><br />
	</div>
	</div>
	<div class="pop_but">
