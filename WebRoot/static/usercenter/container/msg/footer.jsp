...
<div class="popup" id="finishtask" style="top:40%;display:none;">
<div class="title pl20 f14 lh200 bld">任务完成
	<a href="javascript:closeDiv();"><div class="close_div"></div></a></div>
<div class="con">
<div class="ml fl ml20 mt30"><img src="<%=importURL%>/images/usercenter/att_pic2.jpg"></div>
<div class="mr fr">
<dl style="font-size:13px"><dt><b class="success padbot_30">恭喜你！完成了
		[<span class="orange" id='taskName'>开始学习</span>]获得</b></dt><dt><b>任务奖励：</b></dt><dd class="jljf" id='jifen'>奖励积分：×50</dd><dd class="jljy" id='experience'>奖励经验：×80</dd><dd>
</div>
</div>
<div class="pop_but">
<a href="javascript:closeDiv();"><div class="popbut_jh fl ml170"></div></a>
</div>
