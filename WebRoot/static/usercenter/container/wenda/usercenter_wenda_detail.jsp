	...
	<s:else>
		<div class="QA_xqWrap">
			<div class="QA_myAnswer">
				<div class="crumbs">
					<a
						href="<%=contextPath%>/cus/pblimit!getEveryOneProblemList.action?problem.pblType=${problem.pblType }&problem.pblSolv=1&queryProblemCondition.currentPage=1&location=1">问题集合</a>
					&gt; 问题详细
				</div>
				<s:if test="problem.pblSolv==1">
				<a class="QA_xqBack"
					href="<%=contextPath%>/cus/pblimit!getEveryOneProblemList.action?problem.pblType=${problem.pblType }&problem.pblSolv=1&queryProblemCondition.currentPage=1&location=1">返回上一页</a>
				</s:if>
				<s:if test="problem.pblSolv!=1">
				<a class="QA_xqBack"
					href="<%=contextPath%>/cus/pblimit!getEveryOneProblemList.action?problem.pblType=${problem.pblType }&problem.pblSolv=2&queryProblemCondition.currentPage=1&location=0">返回上一页</a>
				</s:if>
