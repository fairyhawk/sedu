...
<title>HighSo嗨学网_个人中心 远程网络职业教育领跑者 尚德机构旗下</title>
<div class="contenter">
	<div class="wd_left">
		...
		<div class="answer_area">
			<div class="tab">
				<ul class="uc_tab">
					<li>
						<a
							href="<%=contextPath%>/cus/pblimit!getMyProblemList.action?problem.pblSolv=1&queryProblemCondition.currentPage=1&sw=0&param_0=1&param_yesno=1"
							class="current" id="param1"><span>我的问题</span> </a>
					</li>
					<li>
						<a
							href="<%=contextPath%>/cus/pblimit!myAnswerProblemList.action?queryProblemCondition.currentPage=1&param_0=0"
							id="param0"><span>我的回答</span> </a>
					</li>
				</ul>
				<div id="uc_tabconMyAnswer1" class="uc_tabcon">
					<div class="tab2">
						<ul class="uc_tab2">
							<li>
								<a
									href="<%=contextPath%>/cus/pblimit!getMyProblemList.action?problem.pblType=1&problem.pblSolv=1&queryProblemCondition.currentPage=1&sw=0&param_0=1&param_yesno=1"
									class="current" id="param11">已解决问题</a>
							</li>
							<li>
								<a
									href="<%=contextPath%>/cus/pblimit!getMyProblemList.action?problem.pblType=1&problem.pblSolv=2&queryProblemCondition.currentPage=1&sw=1&param_0=1&param_yesno=0"
									id="param10">未解决问题</a>
							</li>
						</ul>
								...
								<tbody>
									<s:iterator value="page.pageResult" id="problem">
										<tr>
											<td class="tl">
												<a
													href="<%=contextPath%>/cus/pblimit!getMyProblemContent.action?problem.pblId=<s:property value="#problem.pblId"/>"
