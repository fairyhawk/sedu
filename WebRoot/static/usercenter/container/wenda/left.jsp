...
<div class="nav">
      <ul class="nav_list">
        ...
        <li><a style="cursor:pointer;" onclick="centerLocation(7)" id='uc_left_7'><i class="nav_icon nav_icon_highsoQA"></i>小Hi问答<span class="icon_hot"><img src="<%=importURL%>/images/usercenter/hot_icon.png" width="23" height="14" alt="hot" /></span><span class="nav_num" id="examPaper" style="display: none"></span></a>
         <!--  <ul class="sub_nav">
            <li><a style="cursor:pointer;" onclick="centerLocation(13);">快速回答</a></li>
          </ul> -->
        </li>
        <li><a style="cursor:pointer;" onclick="centerLocation(8);" id='uc_left_9'  ><i class="nav_icon nav_icon_learnPro"></i>学习计划</a>
        </li>
        <li><a style="cursor:pointer;" onclick="centerLocation(10);" id='uc_left_8' ><i class="nav_icon nav_icon_learnAss"></i>学习评估</span></a>
        </li>
