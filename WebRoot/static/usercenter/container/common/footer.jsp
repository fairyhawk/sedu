...
<div style="display: none">
	...
	<div class="popup" id="popbc2">
		<div class="title pl20 f14 lh200 bld">
			提示 <a href="javascript:OnClose();"><div class="close_div"></div></a>
		</div>
		<div class="con">
			<div class="ml fl ml20 mt30">
				<img src="images/att_pic.jpg" />
			</div>
			<div class="mr fr">
				<b>确定要删除该计划吗？</b><br /> 删除学习计划后将无法恢复。按"确定"继续，按"取消"停留在当前页面
			</div>
		</div>
		<div class="pop_but">
			<a href="#"><div class="popbut_qd fl ml100"></div></a>
			<a href="#"><div class="popbut_qx fr mr100"></div></a>
		</div>
	</div>
</div>
<!--警示弹窗结束-->
	...
	<div class="popup" id="popbc2">
		...
		<div class="con">
			<div class="cent fontsize-14">
				...
				<a href="javascript:actCourse()"><div
						class="popbut_jh ml150 mt20"></div></a>
			</div>
			<div class="clear"></div>
		</div>
	</div>
