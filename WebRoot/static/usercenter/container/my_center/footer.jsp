...
<!--提示结束-->
<!--start qq在线咨询-->
<div id="qqOnline" class="qqOnline" style="display:none;">
  <h3>在线咨询</h3>
  <div class="qqOnline_con">
     <dl>
       <dt>课程咨询：</dt>
       <dd class="qqPic"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="courseConsultNumber1"><img src="<%=importURL%>/images/usercenter/qqimg.jpg" width="29" height="26" /></a></dd>
       <dd class="qqName"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="courseConsultNumber2"></a></dd>
     </dl>
     <dl>
       <dt>售后咨询：</dt>
       <dd class="qqPic"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="customerServiceNumber1"><img src="<%=importURL%>/images/usercenter/qqimg.jpg" width="29" height="26" /></a></dd>
       <dd class="qqName"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="customerServiceNumber2"></a></dd>
     </dl>
     <dl>
       <dt>投诉建议：</dt>
       <dd class="qqPic"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="complaintServiceNumber1"><img src="<%=importURL%>/images/usercenter/qqimg.jpg" width="29" height="26" /></a></dd>
       <dd class="qqName"><a href="http://wpa.qq.com/msgrd?v=3&uin=0&site=嗨学网&menu=yes" id="complaintServiceNumber2"></a></dd>
     </dl>
  </div>
  <div class="qqOnline_bt"></div>
  <a id="qqClose" class="qqClose" href="#">关闭</a>
</div>
<!--end qq在线咨询-->
</div>
