...
public class DateUtil {
	...
	public static String addDays(String date,String format, int days) throws ParseException {
		...
		calendar.setTime(DateUtil.toDate(date, format));
...
//	添加 天.小时.分钟
	...
	public static Date getFirstDateOfTheMonth(){
		try{
		    ...
		    return df.parse(df.format(beginTime)+" 00:00:00");
		}catch(Exception e){
			e.printStackTrace();
		}
		return null;
	...
	public static Date getEndDateOfTheMonth(){
		try{
			...
			return df2.parse(df.format(endTime)+" 23:59:59");
		}catch(Exception e){
			e.printStackTrace();
		}
		return null;
	...
	public static void main(String[] args) {
		getHours(new Date("2012-06-27 12:00:00"),new Date("2012-06-27 15:00:00"));
	}
}