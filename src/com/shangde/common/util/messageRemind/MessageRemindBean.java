...
public class MessageRemindBean {
	...
	private String url;//用户点击提醒消息后，将要链接到的地址
	private String text;//提醒消息时，要显示的用户所发主题的标题或内容
	private User sender;//消息发送者，一般均可设为“超级管理员”
	private int type;//来自哪个版块。1：建议;2:问答；3：讨论；4：学习计划；5：课程相关；6：平台欢迎词
	private int tid;//主贴ID
	private int rid;//回贴ID
	private Customer receiver;//消息接收者，也即：主题提出者。
