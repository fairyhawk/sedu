...
public class CusCouKpointImpl extends BaseService implements ICusCouKpoint{
	...
	public List<Course> getCusCouKpointListByCusIdAndSubjectId(QueryCourseCondition queryCourseCondition){
		List<Course> result = new ArrayList<Course>();
		result = simpleDao.getForList("Course_NS.getAllSubjectCourseInfoByIdAndFinance", queryCourseCondition);
	 ...
	 */
	  public List<Books> getBooksListByCusIdAndCourseId(QueryCusCouKpointCondition queryCusCouKpointCondition){
	    	return simpleDao.getForList("CusCouKpoint_NS.getBooksListByCusIdAndCourseId", queryCusCouKpointCondition);
	    }

	@Override
	public List<UserCenterKpointDTO> getUserCenterKpointDTOByCusIdsAndCourseId(Map paramMap) {
		return simpleDao.getForList("CusCouKpoint_NS.getUserCenterKpointDTOByCusIdsAndCourseId", paramMap);
	}

	@Override
	public List<Map<String,Integer>> getCourseVedioSizeByCourseIds(Map courseList) {
		return simpleDao.getForList("CusCouKpoint_NS.getCourseVedioSizeByCourseIds", courseList);
	}
}
