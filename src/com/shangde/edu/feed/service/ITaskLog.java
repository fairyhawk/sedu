...
public interface ITaskLog {
	 ...
	 * @return int
	 */
	public int delTaskLogById(int id);
	 ...
	 * @return
	 */
	public int updateTaskLogUrlClickNum(Map<String, String> map);
	 ...
	 * @return
	 */
	public int updateTaskLogSendNum(int taskListId);
	 ...
	 * @return
	 */
	public int updateTaskLogSendCount(int taskListId);
	 ...
	 * @return
	 */
	public int updateTaskLogSendErrorCount(int taskListId);
