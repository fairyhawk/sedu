...
public class CouponWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(CouponWebAction.class);
	/**
	 * 
	 */
	...
	public String initApplyCoupon(){
		try {
			...
			logger.error("CouponWebAction.initApplyCoupon", e);
			return ERROR;
		}
	...
	public String showUserCpCusList() {
		try{
			...
			logger.error("CouponWebAction.showUserCpCusList", e);
			return ERROR;
		}
	...
	public String addCpCus() {
		try{
			...
			logger.error("CouponWebAction.addCpCus", e);
		}
		return "json";
	}
	...
	public String applyCoupon() {
		try {
			...
			logger.error("CouponWebAction.applyCoupon", e);
			return ERROR;
		}
	...
	public String showCouponByCou(){
		try {
			...
			logger.error("CouponWebAction.showCouponByCou", e);
			return ERROR;
		}
		return "json";
	}
	...
	private void prepareCouponPram() {
		...
		for(int i=0; i<courses.length; i++) {
			try {
				...
				logger.error("CouponWebAction.prepareCouponPram", e);
			}
		}
	...
	public String getCouponCount() {
		try {
			...
			logger.error("CouponWebAction.getCouponCount", e);
			return ERROR;
		}
		return "json";
	}
	...
	public String showMyCoupon() {
		try {
			...
			logger.error("CouponWebAction.showMyCoupon", e);
			return ERROR;
		}
		return "showMyCoupon";
	}
	...
	public String applyCp() {
		try {
			...
			logger.error("CouponWebAction.applyCp", e);
			return ERROR;
		}
		return "json";
	}
...
//				setResult(new Result<Double>(false, "invalid:" + course.getTitle(), null, 0.0));
			...
			logger.error("CouponWebAction.useCp", e);
			return ERROR;
		}
		return "json";
	}
