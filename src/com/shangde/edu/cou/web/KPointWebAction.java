...
public class KPointWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(KPointWebAction.class);
...
//		getQueryKpointCondition().setCourseId(cusid);
		List<JilianKpointDTO> kpointList1;
			...
			logger.error("KPointWebAction.getKpointlistjilian", e);
			return ERROR;
		}
		return "kpontjson";
	}
	...
	public String getAllJSONKpoints(){
		try{
			...
			logger.error("KPointWebAction.getAllJSONKpoints", ex);
			return ERROR;
		}
		return "json";
	}
