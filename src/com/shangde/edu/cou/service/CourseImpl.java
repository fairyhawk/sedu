...
public class CourseImpl extends BaseService implements ICourse{
	...
	@Override
	public Map getVedioByCourseId(int courseId) {
		return simpleDao.getEntity("Course_NS.getVideoFrontByCourseId", courseId);
	}

	@Override
	public List<UserCenterCourseDTO> getUserCenterCourseListBySellId(int sellId) {
		// TODO Auto-generated method stub
		return simpleDao.getForList("Course_NS.getCouserListBySellIdNew", sellId);
	}
	

	@Override
	public List<String> getUserSellWayByCusId(int cusId) {
		return simpleDao.getForList("Course_NS.getUserSellWayByCusId", cusId);
	}

	@Override
	public List<String> getUserCourseByCusId(int cusId) {
		return simpleDao.getForList("Course_NS.getCusCoursePublicByCusId", cusId);
	}
}
