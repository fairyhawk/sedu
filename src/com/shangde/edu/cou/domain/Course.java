...
public void setSubjectName(String subjectName) {
	...
	public int getAllCourseURL() {
		return allCourseURL;
	}

	public void setAllCourseURL(int allCourseURL) {
		this.allCourseURL = allCourseURL;
	}
