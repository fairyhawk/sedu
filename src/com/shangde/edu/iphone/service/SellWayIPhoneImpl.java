...
public class SellWayIPhoneImpl extends BaseService implements ISellWayIPhone {
	...
	public PageResult getSellWayBySubjectId(
			QuerySellWayIPhoneCondition querySellWayIPhoneCondition) {
		// TODO Auto-generated method stub
		return simpleDao.getPageResult("ContractIPhone_NS.getSellWayBySubjectId","ContractIPhone_NS.getSellWayCountBySubjectId",querySellWayIPhoneCondition);
	}
