...
public class PlanAction extends CommentAction {
	...
	public String toGoPlansta() {
		try {
			...
			logger.error("toGoPlansta()方法出错了！",e);
			return "error";
		}
	...
	public String getPlanById() {
		try {
			...
			logger.error("getPlanById()方法出错了！",e);
			return "error";
		}
	...
	public String updatePlan(){
		try{
			...
			logger.error("updatePlan()方法出错了！",e);
			return "error";
		}
	...
	public String toGoPlanList() {
		try {
			...
			logger.error("toGoPlanList()方法出错了！",e);
			return "error";
		}
	}
	...
	public String searchPlan() {
		try {
			...
			logger.error("searchPlan()方法出错了！",e);
			return "error";
		}
	}
