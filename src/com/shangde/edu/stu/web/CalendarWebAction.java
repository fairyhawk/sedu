...
public class CalendarWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(CalendarWebAction.class);
	/**
	 * 
	 */
	...
	*/
	...
	private String getCurrentDayMsg() {
		try{
			...
			logger.error("CalendarWebAction.getCurrentDayMsg", e);
		}
...
//============== 闹钟与 课程 关联	=============================
	...
	private void getCurrenPlanclockByDate(String checkDate) {
		try{
			...
			logger.error("CalendarWebAction.getCurrenPlanclockByDate", e);
		}
	}
	...
	private void getCurrenExamSummaryByDate(String checkDate) {
		try{
			...
			logger.error("CalendarWebAction.getCurrenExamSummaryByDate", e);
		}
	}
...
/*	private void getExampaperRecordList(String checkDate){
	...
	private void getCourseSummaryListBySummarydate(String checkDate) {
		...
		try{
			...
			logger.error("CalendarWebAction.getCourseSummaryListBySummarydate", e);
		}
	}
	...
	public String getPlanListByCalendardChangMonth() {
		try{
			...
			try {
				...
				logger.error("CalendarWebAction.getPlanListByCalendardChangMonth", e);
			}
