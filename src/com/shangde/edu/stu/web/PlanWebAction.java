...
public class PlanWebAction extends CommonAction{
	...
	private static final Logger logger = Logger.getLogger(PlanWebAction.class);
	/**
	 *   学习计划
	 */
	private Plan plan;
    ...
    public String addPlan() {
    	try{
    		...
    		logger.error("PlanWebAction.addPlan", e);
    		return "planAddFalse";
    	}
    ...
    {   	       
    	try{
    		...
    		logger.error("PlanWebAction.getPlanById", e);
			return ERROR;
    	}	
    	 return "getPlan";
    }
    ...
    {   	       
    	try{
    		...
    		logger.error("PlanWebAction.getPlanitemById", e);
			return ERROR;
    	}	
    	 return "getPlanitem";
    }
    ...
    {   	       
    	try{
    		...
    		logger.error("PlanWebAction.getPlanitemByPlanId", e);
			return ERROR;
    	}	
	...
	public String updatePlanitem() {
		try{
			...
			logger.error("PlanWebAction.updatePlanitem", e);
			return ERROR;
		}
	...
	public String deletePlanitemById() {
		try{
			...
			logger.error("PlanWebAction.deletePlanitemById", e);
			return ERROR;
		}
		return "delPlanScu";
	}
	...
	public String getWatchCourseListByDate(){
		...
		try{ 
			...
			logger.error("PlanWebAction.getWatchCourseListByDate", e);
	...
	public void InsertNotWatchCourse(){
		try{
			...
			logger.error("PlanWebAction.InsertNotWatchCourse", e);
		}
	...
	public void InsertNotWatchExam(){
		try{
			...
			logger.error("PlanWebAction.InsertNotWatchExam", e);
		}
	...
	public String getCourseSummaryLimt() {
		...
		try{
			...
			setResult( new Result<String>(false,"failure",null,null));
			logger.error("PlanWebAction.getCourseSummaryLimt", e);
			return "json";
		}
		if(cs != null){
			setResult( new Result<String>(false,"success",null,null));
	...
	public String getCourseSummaryLimtContent() {
		...
		try{
			...
			setResult( new Result<List<String>>(false,"failure",null,null));
    		logger.error("PlanWebAction.getCourseSummaryLimtContent", e);
			return "json";
		}
    ...
    public String getExampaperRecordList(){
    	...
    	try{
    		...
    		setResult( new Result<List<String>>(false,"failure",null,null));
    		logger.error("PlanWebAction.getExampaperRecordList", e);
			return "json";
    	}
    	return "json" ;
    }
    ...
    public String getExamSummaryLimtContent(){ 
    	...
    	try{
    		...
    		*/
    		...
    		setResult( new Result<List<String>>(false,"failure",null,null));
    		logger.error("PlanWebAction.getExamSummaryLimtContent", e);
			return "json";
    	}
    ...
    public String getExampaperById(){
    	...
    	try{
    		...
    		logger.error("PlanWebAction.getExampaperById", e);
    		setResult( new Result<String>(false,"",null,null));
			return "json";
    	}
    ...
    public String getPlanByDate(){
    	try{
    		...
    		logger.error("PlanWebAction.getPlanByDate", e);
			return ERROR;
    	}
	...
	public String getPlanclockListByDate() throws ParseException{
		try{
			...
			logger.error("PlanWebAction.getPlanclockListByDate", e);
			return ERROR;
		}
