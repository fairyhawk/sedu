...
public class DisBackAction extends CommonAction{
	...
	public String getDisList() {
		try{
			...
			log.error("DisBackAction.getDisList", e);
			return ERROR;
		}
		return "dis_list";
	}
	...
	public String toAddDis()
	{
		try{
			...
			log.error("DisBackAction.toAddDis", e);
			return ERROR;
		}
		return "dis_add";
	}
	...
	public String addDis()
	{
		try{
			...
			log.error("DisBackAction.addDis", e);
			return ERROR;
		}
	...
	public String toEditDis()
	{
		try{
			...
			log.error("DisBackAction.toEditDis", e);
			return ERROR;
		}
		return "dis_edit";
	}
	...
	public String editDis(){
		try{
			...
			log.error("DisBackAction.editDis", e);
			return ERROR;
		}
		return "to_dis_list";
	}
	...
	public String topicList()
	{
		try{
			...
			log.error("DisBackAction.topicList", e);
			return ERROR;
		}
		return "topic_list";
	}
	...
	public String showTopic(){
		try{
			...
			log.error("DisBackAction.showTopic", e);
			return ERROR;
		}
	...
	public String editTopic(){
		try{
			...
			log.error("DisBackAction.editTopic", e);
			return ERROR;
		}
		return "topic_edit";
	}
	...
	public String doEditTopic(){
		...
		try {
			...
			log.error("DisBackAction.doEditTopic", e);
			return ERROR;
		}
	...
	public String batchUpdateStatus(){
		...
		try{
			if(topicService.updatebatchUpdateTopicStatus(map) > 0){
				jsonResult = "1";
			}
		}catch (Exception e) {
			jsonResult = "0";
			log.error("DisBackAction.batchUpdateStatus", e);
		}
		return "jsonResult";
	}
	...
	public String addTopic(){
		try{
			...
			log.error("DisBackAction.addTopic", e);
			return ERROR;
		}
		return "topic_add";
	}
	...
	public String doAddTopic(){
		...
		try {
			...
			log.error("DisBackAction.doAddTopic", e);
			return ERROR;
		}
		return SUCCESS;
	}
	...
	public String getDisAreaByDisId(){
		try{
			...
			log.error("DisBackAction.getDisAreaByDisId", e);
			return ERROR;
		}
	...
	public String getReplyList(){
		...
		try {
			...
			log.error("DisBackAction.getReplyList", er);
			return ERROR;
		}
	...
	public String delTopicReplyById()
	{
		try {
			...
			jsonResult = "0";
			log.error("DisBackAction.delTopicReplyById", er);
		}
		//return "topic_reply_list";
		return "jsonResult";
	}
	...
	public String searchTopic(){
		...
		try {
			...
			log.error("DisBackAction.searchTopic", er);
			return ERROR;
		}
		return "topic_list";
	}
	...
	public String searchDis(){
		...
		try {
			...
			log.error("DisBackAction.searchDis", er);
			return ERROR;
		}
		return "dis_list";
	}
	...
	public String addSensWord(){
		try{
			...
			log.error("DisBackAction.addSensWord", e);
			return ERROR;
		}
		return "findSensWord" ;
	}
	...
	public String findSensWord(){
		try{
			...
			log.error("DisBackAction.findSensWord", e);
			return ERROR;
		}
	...
	public String delDisWordById(){
		try{
			...
			log.error("DisBackAction.delDisWordById", e);
			return ERROR;
		}
		return "findSensWord" ;
	}
