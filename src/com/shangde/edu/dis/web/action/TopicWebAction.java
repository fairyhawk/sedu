...
public class TopicWebAction extends CommonAction {
	...
	public String newtopic(){
		try{
			...
			logger.error("TopicWebAction.newtopic", e);
			return ERROR;
		}
		return "dis_newtopic";
	}
	...
	public String mytopic(){
		try{
			...
			logger.error("TopicWebAction.mytopic", e);
			return ERROR;
		}
		return "dis_mytopic";
	}
	...
	public String myRespond(){
		try{
			...
			logger.error("TopicWebAction.myRespond", e);
			return ERROR;
		}
		return "myRespond";
	}
	...
	public String recommend(){
		try{
			...
			logger.error("TopicWebAction.recommend", e);
			return ERROR;
		}
	...
	public String findTopicUpdate(){
		try{
			...
			logger.error("TopicWebAction.findTopicUpdate", e);
			return ERROR;
		}
		return "topic_update";
	}
	...
	public String doEdit() {
		...
		try {
			...
			jsonResult = "0";
			logger.error("TopicWebAction.doEdit", e);
		}
		return "topic_edit";
	}
	...
	public String recommended() {
		...
		try {
			...
			//校验积分是否在扣除积分的范围之内
			if (totolsScore.getTsCurrent()!=0 && totolsScore.getTsCurrent()>= lostValue) {
				//执行扣积分运算
				totolsScore
