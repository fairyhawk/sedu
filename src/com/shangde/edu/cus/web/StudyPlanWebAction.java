...
public class StudyPlanWebAction extends CommonAction{
	...
	private static final Logger logger = Logger.getLogger(StudyPlanWebAction.class);
	...
	public List<Integer> getMonthStudyPlan(String timeStr) {
		...
		try {
			...
			logger.error("StudyPlanWebAction.getMonthStudyPlan", e);
		}
		return list;
	}
	...
	public String deleteStudyPlan(){
		try {
			...
			logger.error("StudyPlanWebAction.deleteStudyPlan", e);
			return ERROR;
		}
		return "relist";
	}
