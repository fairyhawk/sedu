...
public class TsRecordWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(TsRecordWebAction.class);
	/**
	 * 积分记录的服务
	 */
	...
	public String getTsRecordListByCus() {
		try {
			...
			logger.error("TsRecordWebAction.getTsRecordListByCus", ex);
			return ERROR;
		}
	...
	public String getTsRecordHelp(){
		try {
			...
			logger.error("TsRecordWebAction.getTsRecordHelp", ex);
			return ERROR;
		}
		return "getTsRecordListByCus";
	}
