...
public class TotolsScoreWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(TotolsScoreWebAction.class);
...
//				tsRecord.setAccessTime(date);
			...
			logger.error("TotolsScoreWebAction.forCoupon", ex);
			return ERROR;
		}
		return "json";
	}
	...
	public String getExperienceLevel(){
		try {
			...
			exp.setTsCurrent(tScore.getTsCurrent());
			if(expvalue<60){
				exp.setExpLevel(1);
				exp.setExpName("新手上路");
			...
			logger.error("TotolsScoreWebAction.getExperienceLevel", ex);
			return ERROR;
		}
		return "json";
	} 
