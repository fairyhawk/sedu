...
public class TaskWebAction extends CommonAction {
	...
	private static final Logger logger = Logger.getLogger(TaskWebAction.class);
	/**
	 * 任务
	 */
	private Task task;
	...
	public String getWebTaskList(){
		try{
			...
			logger.error("TaskWebAction.getWebTaskList", ex);
			return ERROR;
		}
	...
	public String getTaskEncourage(){
		try{
			...
			logger.error("TaskWebAction.getTaskEncourage", ex);
			this.setResult(new Result<Object>(true, "false", null, null));
		}
