...
return simpleDao.createEntity("FinanceCoupon_NS.createCoupon",coupon);
    }
    ...
    public PageResult getCouponListByWhere(QueryCouponCondition queryCouponCondition) {
        return simpleDao.getPageResult("FinanceCoupon_NS.getCouponCodeListByWhere","FinanceCoupon_NS.getCouponCodeListCountByWhere",queryCouponCondition);
    }
	...
	public int getCouponCountByCus(int userId) {
	 ...
	 * @return 
	 */
	public int addCreateCoupon(Coupontype coupontype){
	...
	public int addConperation(Cooperation cooperation){
	...
	public void addCouPon(Coupon coupon){
		simpleDao.createEntity("FinanceCoupon_NS.addCreateCoupon", coupon);
	}
	/**
	 * 根据type查询所对应的coding
	 * @param codingId
	...
	public void updateCouponTypeGenerateTime(Coupontype coupontype){
		simpleDao.updateEntity("CouponType_NS.updateCouponTypeGenerateTime", coupontype);
	}
	/**
	 * 检验是否已近生成了又会变吗；
	 * 
