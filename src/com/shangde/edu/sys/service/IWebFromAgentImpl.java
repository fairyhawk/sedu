...
public class IWebFromAgentImpl extends BaseService implements IWebFromAgent {
	...
	public PageResult getWebFromAgentCountByTiaoJian(QueryWebFromAgentCondition queryWebFromAgentCondition){
		return simpleDao.getPageResult("WebFromAgent_NS.getWebFromAgentByTiaoJian","WebFromAgent_NS.getWebFromAgentCountByTiaoJian",queryWebFromAgentCondition);
	}
	/**
	 * Author:yanbaixi
